    ...
    <div id="content">
        ...
        <div class="content-header d-flex align-items-center">
            ...
            <div class="content-header-right d-flex align-items-center ms-auto">
                <a href="{{ route('pages.create') }}" type="button" class="btn btn-blue">+ {{__('New Page')}}</a>
            </div>
        </div>
        <div class="content-body p-0">
            <div class="card table-card px-5 py-3">
                <div class="card-header header-elements-inline px-0 py-3">
                    <h6 class="card-title fs-14">{{__('All Pages')}}</h6>
                ...
                <table class="table table-responsive datatable-basic pages-table" id="data-table">
                    <thead>
                    <tr>
                        <th>{{__('ID')}}</th>
                        <th>{{__('Code')}}'</th>
