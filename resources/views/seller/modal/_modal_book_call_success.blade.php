<div class="modal fade" id="book-a-call-response" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content overflow-visible">
            <div class="modal-body text-center">
                ...
                <p>{{__('Your call with Aarit is set to')}} <b>{{__('Aug')}} 23rd</b> at <b>13:00</b></p>
