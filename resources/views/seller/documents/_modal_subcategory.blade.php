<div class="modal fade" id="add_subcategory_modal" tabindex="-1" role="dialog" aria-labelledby="add_subcategory_modal" aria-hidden="true">
        ...
        <div class="modal-content overflow-visible">
            <div class="modal-body p-4 p-sm-5">
                ...
                <form class="sub_category_form" action="{{route('seller.category.subCategoryStore')}}" method="POST" enctype="multipart/form-data">   
                    <div class="row">
                        <input type="hidden" name="model_type" value="document">
                        <div class="col-md-12 col-12">
                            ...
                            <div class="mb-0">
                                <button class="btn btn-blue" id="videosubcategory_form_submit_btn" type="submit">+ {{__('Add Sub Category')}}<span class="spinner"></span></button>
                            </div>
                        </div>
                    </div>
                </form>
