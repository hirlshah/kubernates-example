                            ...
                            <table style="min-width: 1200px; width: 1200px; margin: 0 auto; overflow: auto;">
                                <tr style="width: 100%; float: left; box-sizing: border-box;">
                                    <td style="width: 50%; float: left; box-sizing: border-box;">
                                        ...
                                        <h1 style="color: #56B2FF; font-size: 30px;">{{ $watching_user_name }} {{__('has finished to watch your video, ')}}<a href="tel:{{ $watching_user_phone }}" style="color: #56B2FF; font-size: 30px;">{{__('contact them!')}}</a></h1>
                                            ...
                                            <tr>
                                                <td style="border-radius: 20px;">
                                                    ...
                                                    <div style="padding: 25px; float:left;">
                                                        ...
                                                        @if(!empty($category))
                                                            <a style="border: 1px solid #0000001f; padding: 12px; border-radius: 44px; color: #323232; text-decoration: none; margin-right: 10px; font-weight: 500; font-size: 12px;"> {{ $category }} </a>
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
